...
artifacts/root/check-venv/bin/pytest -q \
  ...
  packages/bijux-pollenomics/tests/regression/repository_contracts/test_documentation_content.py::DocumentationContentTests::test_docs_mermaid_diagrams_avoid_reserved_node_ids
```
