---
title: Geographic Evidence Surfaces
audience: reader
type: explanation
status: canonical
...
# Geographic Evidence Surfaces

The checked-in publication tree now starts from one broad world surface and
derives narrower regional and country views from it. This is the durable model
for public geography outputs.
...
- [geographic point publication](geographic-point-publication.md)
- [geographic filters and inspection](geographic-filters-and-inspection.md)
- [geographic limits and honesty](geographic-limits-and-honesty.md)
- [geographic input surfaces](geographic-input-surfaces.md)

These surfaces are still downstream publication artifacts. They are useful
because they make evidence legible, not because they outrank the underlying
sample, locality, chronology, or coordinate records.
