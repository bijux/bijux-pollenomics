...
- `adna/` owns species-aware ancient-DNA contracts, non-human normalization,
  ...
  project-level paper linkage and scientific metadata, Homo sapiens runtime manifests,
  metadata-only analysis boundaries, archive-integrity review, and scientist-facing species review packets
...
If a question is about curated ENA archive intake metadata, project-level
paper linkage, species review packets, or map-ready animal rows, the answer
should usually be traceable back into `src/bijux_pollenomics/adna/`.
