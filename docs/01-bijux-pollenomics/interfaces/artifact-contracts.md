...
- root-level report artifacts include `animal_output_audit.*`, `animal_atlas_readiness.*`, `animal_country_species_coverage.*`, chronology overlap artifacts, and scenario posture artifacts
