...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `docs/report/animal_atlas_exclusion_report.md` | `structured_reference` | 0 | 0 | 1 | 316 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
...
| `docs/report/animal_country_species_coverage.md` | `structured_reference` | 0 | 0 | 0 | 4 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
| `docs/report/animal_cross_surface_drift.md` | `structured_reference` | 0 | 0 | 0 | 9 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
| `docs/report/animal_first_appearance_by_country.md` | `structured_reference` | 0 | 0 | 0 | 4 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
| `docs/report/animal_foundation_review.md` | `reader_ready` | 3 | 0 | 9 | 0 | 3 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/animal_output_honesty.md` | `structured_reference` | 0 | 0 | 0 | 9 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
| `docs/report/animal_point_evidence_review.md` | `reader_ready` | 233 | 0 | 466 | 0 | 234 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/animal_project_publication_gap_review.md` | `structured_reference` | 0 | 0 | 1 | 37 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
...
| `docs/report/animal_sample_database_review.md` | `reader_ready` | 5 | 0 | 50 | 0 | 6 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/animal_temporal_comparison_review.md` | `reader_ready` | 3 | 0 | 4 | 4 | 3 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/countries/denmark/denmark_animal_adna_v66_samples.md` | `thin_structure` | 1 | 0 | 0 | 4 | 1 | Page explains itself but still needs stronger internal wayfinding. |
| `docs/report/countries/denmark/denmark_animal_adna_v66_warnings.md` | `thin_structure` | 1 | 0 | 0 | 0 | 1 | Page explains itself but still needs stronger internal wayfinding. |
| `docs/report/countries/finland/README.md` | `reader_ready` | 6 | 0 | 7 | 12 | 6 | Page explains its purpose before or alongside artifact links. |
| `docs/report/countries/finland/finland_aadr_v66_samples.md` | `structured_reference` | 0 | 0 | 0 | 34 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
| `docs/report/countries/finland/finland_animal_adna_v66_citations.md` | `thin_structure` | 1 | 0 | 0 | 3 | 1 | Page explains itself but still needs stronger internal wayfinding. |
| `docs/report/countries/finland/finland_animal_adna_v66_samples.md` | `thin_structure` | 1 | 0 | 0 | 3 | 1 | Page explains itself but still needs stronger internal wayfinding. |
| `docs/report/countries/finland/finland_animal_adna_v66_warnings.md` | `thin_structure` | 1 | 0 | 0 | 0 | 1 | Page explains itself but still needs stronger internal wayfinding. |
| `docs/report/countries/norway/README.md` | `reader_ready` | 6 | 0 | 7 | 21 | 6 | Page explains its purpose before or alongside artifact links. |
| `docs/report/countries/norway/norway_aadr_v66_samples.md` | `structured_reference` | 0 | 0 | 0 | 132 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
...
| `docs/report/countries/sweden/sweden_lake_archaeology_sensitivity_v66.md` | `reader_ready` | 6 | 0 | 0 | 2 | 4 | Page explains its purpose before or alongside artifact links. |
| `docs/report/countries/sweden/sweden_lake_evidence_richness_v66.md` | `thin_structure` | 2 | 0 | 4 | 0 | 1 | Page explains itself but still needs stronger internal wayfinding. |
| `docs/report/countries/sweden/sweden_lake_fieldwork_preparation_v66.md` | `reader_ready` | 2 | 0 | 9 | 3 | 3 | Page explains its purpose before or alongside artifact links. |
| `docs/report/countries/sweden/sweden_land_use_synthesis_v66.md` | `reader_ready` | 5 | 0 | 5 | 8 | 4 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/europe-plus/README.md` | `reader_ready` | 8 | 0 | 58 | 17 | 14 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/europe-plus/europe-plus_evidence_surface.md` | `reader_ready` | 1 | 0 | 0 | 46 | 4 | Page explains its purpose before or alongside artifact links. |
| `docs/report/regions/europe-plus/europe-plus_map_publication_contract.md` | `reader_ready` | 6 | 0 | 6 | 5 | 7 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/europe-plus/europe-plus_scientific_review.md` | `reader_ready` | 3 | 0 | 8 | 163 | 10 | Page explains its purpose before or alongside artifact links. |
| `docs/report/regions/nordic/README.md` | `reader_ready` | 9 | 0 | 97 | 22 | 14 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/nordic/nordic_evidence_surface.md` | `reader_ready` | 1 | 0 | 0 | 46 | 4 | Page explains its purpose before or alongside artifact links. |
| `docs/report/regions/nordic/nordic_map_publication_contract.md` | `reader_ready` | 7 | 0 | 14 | 10 | 7 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/nordic/nordic_scientific_review.md` | `reader_ready` | 3 | 0 | 8 | 227 | 10 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/repository_credibility_dashboard.md` | `structured_reference` | 0 | 0 | 1 | 10 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
| `docs/report/repository_cross_domain_evidence_matrix.md` | `structured_reference` | 0 | 0 | 0 | 8 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
| `docs/report/repository_docs_recovery_review.md` | `structured_reference` | 0 | 0 | 1 | 6 | 2 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
| `docs/report/repository_docs_restoration_ledger.md` | `thin_structure` | 1 | 0 | 1 | 70 | 1 | Page explains itself but still needs stronger internal wayfinding. |
...
| `docs/report/world/README.md` | `reader_ready` | 8 | 0 | 102 | 19 | 14 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/world/world_evidence_surface.md` | `reader_ready` | 1 | 0 | 0 | 46 | 4 | Page explains its purpose before or alongside artifact links. |
| `docs/report/world/world_map_publication_contract.md` | `reader_ready` | 6 | 0 | 6 | 6 | 7 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/world/world_scientific_review.md` | `reader_ready` | 3 | 0 | 8 | 184 | 10 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/maintenance/index.md` | `reader_ready` | 3 | 10 | 4 | 0 | 4 | Page explains its purpose before or alongside artifact links. |
| `docs/report/maps/index.md` | `reader_ready` | 3 | 3 | 4 | 0 | 4 | Page explains its purpose before or alongside artifact links. |
| `docs/report/reviews/index.md` | `reader_ready` | 3 | 5 | 4 | 0 | 4 | Page explains its purpose before or alongside artifact links. |
| `docs/report/scopes/index.md` | `reader_ready` | 3 | 4 | 4 | 0 | 4 | Page explains its purpose before or alongside artifact links. |
