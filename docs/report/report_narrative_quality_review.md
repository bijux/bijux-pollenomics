...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `docs/report/animal_atlas_exclusion_report.md` | `structured_reference` | 0 | 0 | 1 | 899 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
...
| `docs/report/animal_human_chronology_overlap.md` | `thin_structure` | 1 | 0 | 1 | 4 | 1 | Page explains itself but still needs stronger internal wayfinding. |
...
| `docs/report/animal_pollen_chronology_overlap.md` | `thin_structure` | 1 | 0 | 1 | 4 | 1 | Page explains itself but still needs stronger internal wayfinding. |
...
| `docs/report/animal_sample_chronology_review.md` | `reader_ready` | 1 | 0 | 3 | 1453 | 2 | Page explains its purpose before or alongside artifact links. |
| `docs/report/animal_sample_database_review.md` | `reader_ready` | 5 | 0 | 48 | 0 | 6 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/europe-plus/europe-plus_evidence_surface.md` | `reader_ready` | 1 | 0 | 0 | 48 | 4 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/nordic/README.md` | `reader_ready` | 9 | 0 | 168 | 23 | 14 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/nordic/nordic_map_publication_contract.md` | `reader_ready` | 7 | 0 | 14 | 11 | 7 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/nordic/nordic_scientific_review.md` | `reader_ready` | 3 | 0 | 8 | 243 | 10 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/world/world_evidence_surface.md` | `reader_ready` | 1 | 0 | 0 | 48 | 4 | Page explains its purpose before or alongside artifact links. |
