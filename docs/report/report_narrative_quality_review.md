...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `docs/report/animal_atlas_exclusion_report.md` | `structured_reference` | 0 | 0 | 1 | 341 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
...
| `docs/report/animal_cross_surface_drift.md` | `structured_reference` | 0 | 0 | 0 | 12 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
...
| `docs/report/animal_foundation_review.md` | `reader_ready` | 3 | 0 | 10 | 0 | 3 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/countries/sweden/README.md` | `reader_ready` | 8 | 0 | 24 | 24 | 9 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/countries/sweden/sweden_lake_evidence_richness_v66.md` | `reader_ready` | 2 | 0 | 3 | 107 | 8 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/europe-plus/europe-plus_evidence_surface.md` | `reader_ready` | 1 | 0 | 0 | 49 | 4 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/nordic/README.md` | `reader_ready` | 9 | 0 | 54 | 22 | 14 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/nordic/nordic_scientific_review.md` | `reader_ready` | 3 | 0 | 8 | 211 | 10 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/world/world_evidence_surface.md` | `reader_ready` | 1 | 0 | 0 | 49 | 4 | Page explains its purpose before or alongside artifact links. |
