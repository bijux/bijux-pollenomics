...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `docs/report/animal_atlas_exclusion_report.md` | `structured_reference` | 0 | 0 | 1 | 897 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
...
| `docs/report/animal_country_species_coverage.md` | `structured_reference` | 0 | 0 | 0 | 5 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
...
| `docs/report/animal_human_chronology_overlap.md` | `thin_structure` | 1 | 0 | 1 | 5 | 1 | Page explains itself but still needs stronger internal wayfinding. |
...
| `docs/report/animal_point_evidence_review.md` | `reader_ready` | 235 | 0 | 472 | 0 | 236 | Page explains its purpose before or alongside artifact links. |
| `docs/report/animal_pollen_chronology_overlap.md` | `thin_structure` | 1 | 0 | 1 | 5 | 1 | Page explains itself but still needs stronger internal wayfinding. |
| `docs/report/animal_project_publication_gap_review.md` | `structured_reference` | 0 | 0 | 1 | 36 | 1 | Page is table-heavy, but it behaves like a reference surface rather than a loose link dump. |
...
| `docs/report/animal_temporal_comparison_review.md` | `reader_ready` | 3 | 0 | 5 | 4 | 3 | Page explains its purpose before or alongside artifact links. |
| `docs/report/countries/denmark/README.md` | `reader_ready` | 7 | 0 | 21 | 25 | 8 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/countries/denmark/denmark_animal_adna_v66_citations.md` | `thin_structure` | 1 | 0 | 0 | 4 | 1 | Page explains itself but still needs stronger internal wayfinding. |
| `docs/report/countries/denmark/denmark_animal_adna_v66_samples.md` | `thin_structure` | 1 | 0 | 0 | 6 | 1 | Page explains itself but still needs stronger internal wayfinding. |
...
| `docs/report/nordic_farming_history_scenario.md` | `reader_ready` | 3 | 0 | 7 | 0 | 4 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/europe-plus/README.md` | `reader_ready` | 8 | 0 | 59 | 20 | 14 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/regions/nordic/README.md` | `reader_ready` | 9 | 0 | 204 | 29 | 14 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/world/README.md` | `reader_ready` | 8 | 0 | 103 | 22 | 14 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/world/world_map_publication_contract.md` | `reader_ready` | 6 | 0 | 6 | 7 | 7 | Page explains its purpose before or alongside artifact links. |
...
| `docs/report/world/world_scientific_review.md` | `reader_ready` | 3 | 0 | 8 | 200 | 10 | Page explains its purpose before or alongside artifact links. |
