...
- the shipped animal atlas still exposes only 207 published animal point rows
- 39 animal rows remain unresolved for mapping and 8 are refused from mapping
