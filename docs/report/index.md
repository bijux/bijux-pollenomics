...
| --- | ---: | --- |
| Map surfaces | `79` | interactive surfaces, traceability, contracts, and atlas-facing evidence rows |
| Scope-filtered outputs | `167` | world, regional, and country bundles that answer geography-first reading questions |
