...
| --- | ---: | --- |
| Map surfaces | `80` | interactive surfaces, traceability, contracts, and atlas-facing evidence rows |
| Scope-filtered outputs | `438` | world, regional, and country bundles that answer geography-first reading questions |
