...
| --- | ---: | --- |
| Map surfaces | `83` | interactive surfaces, traceability, contracts, and atlas-facing evidence rows |
| Scope-filtered outputs | `506` | world, regional, and country bundles that answer geography-first reading questions |
...
| Maintainer truth surfaces | `50` | repository truth, docs integrity, source audits, and geography governance surfaces |
...
- Public reading surface: `509`
- Scientific review surface: `117`
