...
| --- | --- | ---: |
| published_points_keep_required_traceability | `true` | 0 |
| project_recovery_guard_still_blocks_overclaim | `true` | 0 |
| project_locality_outputs_do_not_flatten_sample_site_disagreement | `true` | 0 |
