...
| --- | --- | --- | --- |
| SEAD | `direct_source_infrastructure` | `high_value_direct_context_partner` | environmental archaeology context with strong Sweden, Scandinavia, and wider European relevance |
| PalaeOpen | `open_data_network` | `high_value_interoperability_network` | metadata, taxonomy, and multi-repository palaeoecology alignment for cross-proxy lake comparison |
...
- Official entry points: `https://palaeopen.github.io/`, `https://palaeopen.github.io/About/about.html`, `https://palaeopen.github.io/join_us.html`
