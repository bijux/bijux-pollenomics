...
The current public report tree now ships `18` mapped non-human animal atlas layer rows across the species table above. Country-bundle animal outputs remain zero until those country surfaces become real tracked report outputs.
