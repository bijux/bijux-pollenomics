...
| SEAD archaeology context | `contextual_domain` | 2 | `tracked_context_layer` | SEAD provides environmental archaeology context and should not disappear behind animal intake work |
| RAÄ archaeology context | `contextual_domain` | 2 | `tracked_context_layer` | RAÄ remains Sweden-scoped archaeology context and should keep its explicit national scope |
| Boundary geometry | `framing_domain` | 1 | `tracked_boundary_frame` | Boundary layers are one of the clearest repository surfaces and keep region framing honest |
