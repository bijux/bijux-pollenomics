...
- Source temporal coverage: Neotoma 81/99 numeric-interval records (BP site spans available; chronology rows absent in checked-in raw capture), LandClim 0/198 numeric-interval records (spatial inventory only), SEAD 0/2007 numeric-interval records (site inventory only in checked-in raw capture)
