...
| Homo sapiens | sweden-archaeology-site-discovery | locality_level_overlap_available | 444 | 0 | 3 | Human locality chronology can be compared directly with time-aware context points. |
