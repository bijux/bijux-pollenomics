...
| SEAD | linked chronology claim for comparison; site row for spatial discovery | archaeology context | 25,109 claims include 14,324 comparable claims; the atlas carries 2,069 four-country site features and 9,738 Swedish chronology-discovery features |
