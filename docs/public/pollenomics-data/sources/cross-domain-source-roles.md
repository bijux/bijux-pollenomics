...
| SEAD | environmental-archaeology site inventory row | archaeology context | mixed temporal context: 497 mapped numeric site envelopes plus label-only and unresolved sites |
