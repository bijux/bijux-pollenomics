...
- giving a newcomer one route into maps, scope bundles, reviews, and caveats
...
The report tree is the public face of the repository. If readers do not
understand its structure, they are likely to confuse one polished view with the
entire evidence base behind it.
