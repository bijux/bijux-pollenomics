...
| Contextual support outputs | archaeology, boundary, and fieldwork layers | `nordic_environmental_sites.geojson`, `sweden_archaeology_density.geojson`, `nordic_country_boundaries.geojson`, `docs/public/fieldwork/` | contextual framing, not direct pollen or sample evidence |
