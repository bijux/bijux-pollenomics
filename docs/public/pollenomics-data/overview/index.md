...
the same strengths, the same gaps, or the same publication maturity, so they
need a clear introduction before readers move into the details.
...
That usually happens because readers meet a generated report, a source audit,
and a normalized evidence file side by side without being told why they exist
or which one governs the claim.

This overview solves that by making three boundaries explicit:
...
Those boundaries are simple, but they make the rest of the handbook easier to
read.
