...
# Bijux Pollenomics Public Guide

This part of the site is the public surface for `bijux-pollenomics`.
...
animal ancient DNA. This guide is the reader-facing entrypoint for that public
surface.
...
<div class="bijux-quicklinks">
  <a class="md-button md-button--primary" href="pollenomics/">Open the product guide</a>
  <a class="md-button" href="pollenomics-data/">Open the data guide</a>
  ...
  <a class="md-button" href="nordic-atlas/">Open the atlas guide</a>
  <a class="md-button" href="fieldwork/">Open the fieldwork record</a>
</div>

Read the public surface in this order:
...
- product guide: [pollenomics](pollenomics/index.md)
- data guide: [pollenomics-data](pollenomics-data/index.md)
- report portal: [report/index.md](../report/index.md)
- Nordic atlas guide: [nordic-atlas](nordic-atlas/index.md)
- fieldwork record: [fieldwork](fieldwork/index.md)
...
- what the runtime rebuilds: [pollenomics](pollenomics/index.md)
- what this repository does and where its limits are:
  [public guide](index.md)
- what the tracked data system and source families are:
  [pollenomics-data](pollenomics-data/index.md)
- how the publication tree is organized for readers:
  [report portal](../report/index.md)
- how the map points, filters, and honesty surfaces work:
  [nordic-atlas](nordic-atlas/index.md)
