# Reindeer Evidence View

`Rangifer tarandus` is a species-owned projection over project, paper,
...
| Signal | Meaning |
| --- | --- |
| product role `comparator` | the intended contribution of this taxon to governed products |
| dataset bucket `comparator_only` | the present evidence grouping, not a biological category |
| curation class `comparator_only` | the evidence rule used to classify project support |
