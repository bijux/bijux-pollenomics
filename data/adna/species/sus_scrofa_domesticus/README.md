...
`Sus scrofa domesticus` is a species-owned projection over project, paper,
...
- Curated sample rows: `343`
- Curated projects: `1`
- Curated site rows: `106`
- Direct-coordinate rows: `0`
- Geocoded rows: `2`
- Unresolved sample rows: `341`
- Mapped Nordic rows: `6`
