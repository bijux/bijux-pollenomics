...
- Sample count artifact path: `data/adna/governance/source_library/projects/PRJNA421430/archive_metadata.html`
- Sample identifier status: `not_yet_curated`
- Rejection reason: `Method and modern tissue context from the source note set; not curated ancient pig support.`
