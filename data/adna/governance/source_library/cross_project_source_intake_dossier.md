...
| --- | --- | --- | --- |
| `PRJEB31621` | `10.1126/science.aav1002` | `sample_identifiers; taxonomic_context; site_names; coordinate_resolution_candidate; chronology` | `local_supplement_staged_needs_repo_ingestion` |
| `PRJEB75467` | `10.1038/s41586-024-08112-6` | `sample_identifiers; taxonomic_context; site_names; coordinate_resolution_candidate; chronology` | `local_supplement_staged_needs_repo_ingestion` |
...
| `SRP073444` | `10.1111/1755-0998.12551` | `sample_identifiers; taxonomic_context; site_names; coordinate_resolution_candidate; chronology` | `local_supplement_staged_needs_repo_ingestion` |
...
| `PRJEB60484` | `10.1038/s41598-024-54296-2` | `sample_identifiers; taxonomic_context; site_names; coordinate_resolution_candidate; chronology` | `local_supplement_staged_needs_repo_ingestion` |
| `PRJEB61721` | `none` | `sample_identifiers` | `scope_rejected` |
| `PRJNA634908` | `none` | `sample_identifiers` | `scope_rejected` |
| `PRJEB30282` | `10.1073/pnas.1901169116` | `sample_identifiers; taxonomic_context; site_names; coordinate_resolution_candidate; chronology` | `local_supplement_staged_needs_repo_ingestion` |
