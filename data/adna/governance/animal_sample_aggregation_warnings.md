...
- Project accession anchors: `35`
- Accession-range anchors: `15`
- Sample accession anchors: `2`
- Project-locality summaries: `10`
- Projects with project-level sample anchors: `37`
- Projects with locality count drift: `0`
- Species with summary count drift: `0`

- `project_level_sample_anchors`: `37`. Projects whose current sample rows are still anchored at project or accession-range level rather than true per-sample identifiers.
