...
class DocsBreadthRegressionTests(unittest.TestCase):
    ...
    def test_nordic_atlas_documents_sweden_lake_decision_support(self) -> None:
        ...
        self.assertIn("ranks 26 evidence-linked SMHI SVAR lakes", lake_text)
        self.assertIn("full 40,565-lake capture", lake_text)
        self.assertIn("fieldwork-preparation posture", lake_text)
