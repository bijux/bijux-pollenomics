...
class AdnaProjectSampleSitesUnitTests(unittest.TestCase):
    ...
    def test_horse_project_sample_sites_publish_direct_botai_rows(self) -> None:
        ...
        self.assertEqual(botai.location_evidence_artifact_kind, "supplementary_spreadsheet_row")
        self.assertEqual(botai.chronology_text, "5500 BP")

    def test_horse_nordic_project_sample_sites_keep_country_and_direct_coordinate_posture(self) -> None:
