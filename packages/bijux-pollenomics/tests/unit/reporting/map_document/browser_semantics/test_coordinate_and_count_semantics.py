...
console.log(JSON.stringify({
  ...
  arrayPair: featureCoordinatePair({latitude:[], longitude:18}),
  singletonArrayPair: featureCoordinatePair({latitude:[0], longitude:18}),
  objectPair: featureCoordinatePair({latitude:{}, longitude:18}),
  ...
  stringZeroCount: countDisplayValue('0', null),
  stringOneCount: countDisplayValue('1', null),
  booleanCount: countDisplayValue(true, null),
  blankCount: countDisplayValue('', null),
  invalidCount: countDisplayValue('nan', ''),
  arrayCount: countDisplayValue([], ''),
  singletonArrayCount: countDisplayValue([0], ''),
  objectCount: countDisplayValue({}, ''),
...
"""
    ...
    assert observed == {
        ...
        "zeroCount": "0",
        "stringZeroCount": "Unavailable",
        "stringOneCount": "Unavailable",
        "booleanCount": "Unavailable",
        "blankCount": "Unavailable",
        "invalidCount": "Unavailable",
        "arrayCount": "Unavailable",
        "singletonArrayCount": "Unavailable",
        "objectCount": "Unavailable",
