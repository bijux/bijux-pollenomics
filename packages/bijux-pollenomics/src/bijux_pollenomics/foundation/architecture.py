...
def build_repository_architecture_contract() -> RepositoryArchitectureContract:
    ...
    lifecycle_stages = (
        ...
        ArchitectureStage(
            ...
            tracked_inputs=("data", "data/adna/species", "review packets"),
    ...
    animal_adna_stages = (
        ...
        ArchitectureStage(
            ...
            tracked_inputs=("source-library packets", "archive manifests"),
        ...
        ArchitectureStage(
            ...
            tracked_outputs=("governance review packets", "release gates"),
        ...
        ArchitectureStage(
            ...
            tracked_inputs=("data/adna/final", "validation packets"),
            tracked_outputs=("docs/report",),
    ...
    cross_tree_surfaces = (
        ...
        CrossTreeSurfaceContract(
            ...
            purpose="governed public outputs, review packets, and release-facing artifacts",
        ),
        CrossTreeSurfaceContract(
