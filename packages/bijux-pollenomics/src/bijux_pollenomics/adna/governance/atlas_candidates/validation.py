"""Reject animal-atlas candidates that would erase sample-site identity."""
...
_SOURCE_SAMPLE_SCOPE_MARKERS: dict[tuple[str, str], dict[str, tuple[str, ...]]] = {
...
_SOURCE_SAMPLE_GROUP_SCOPE_RULES: dict[tuple[str, str], dict[str, str]] = {
    ("equus_caballus", "PRJEB44430"): {
