...
def build_external_polygon_layer(
    ...
    *,
    ...
    return {
        ...
        "source_name": POLYGON_LAYER_METADATA.get(layer_key, {}).get(
            "source_name", layer_label
        ),
        "coverage_label": POLYGON_LAYER_METADATA.get(layer_key, {}).get(
            "coverage_label", "Country-aware context polygons."
        ),
        "geometry_label": POLYGON_LAYER_METADATA.get(layer_key, {}).get(
            "geometry_label", "Polygon records"
        ),
