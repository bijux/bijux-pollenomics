...
_GATE_TESTS: dict[str, tuple[str, ...]] = {
    "science": (
        ...
        "test_propagation_evidence_domains.py",
        "test_scientific_review.py",
        "test_source_spatiotemporal_posture.py",
        "test_propagation_network.py",
    ),
    "data": (
        "test_adna_normalization.py",
        "test_adna_catalogs.py",
        "test_adna_project_sample_locality_evidence.py",
        "test_adna_runtime.py",
        "test_adna_sample_master.py",
        "test_adna_sample_truth.py",
        "test_adna_source_library.py",
        "test_adna_source_recovery.py",
        "test_adna_temporal_query.py",
        "test_sead_acquisition.py",
        "test_sead_acquisition_admission.py",
        "test_sead_claim_bundle.py",
        "test_sead_observation_acquisition.py",
        "test_sead_scoped_acquisition.py",
        "test_neotoma_data.py",
        "test_neotoma_lineage_review.py",
        "test_neotoma_relational.py",
        "test_neotoma_materialization.py",
        "test_neotoma_production.py",
        "test_landclim_data.py",
        "test_landclim_raw_receipt.py",
        "test_raa_data.py",
        "test_raa_authority.py",
        "test_svar_data.py",
        "test_boundaries.py",
        "test_boundary_country_review.py",
        "test_data_contract_surfaces.py",
        "test_data_layout.py",
        "test_source_identity.py",
        "test_source_family_contracts.py",
        "test_source_layout_contract.py",
        "test_source_provenance.py",
        "test_source_traceability.py",
        "test_source_validation.py",
    ),
    "map": (
        "test_map_evidence_projection.py",
        ...
        "test_evidence_surface.py",
        "test_propagation_outputs.py",
        "test_public_artifact_language.py",
    ),
    "provenance": (
        "test_release_evidence.py",
        "test_release_evidence_writer.py",
        "test_recorded_gates.py",
...
_GATE_GLOBS: dict[str, tuple[str, ...]] = {
    ...
    "data": (
        ...
        "packages/bijux-pollenomics/src/bijux_pollenomics/data_downloader/*.py",
        "packages/bijux-pollenomics/src/bijux_pollenomics/data_downloader/*/*.py",
        "packages/bijux-pollenomics/src/bijux_pollenomics/data_downloader/*/*/*.py",
