...
_GATE_TESTS: dict[str, tuple[str, ...]] = {
    "science": (
        ...
        "collection/sources/sead/test_sead_chronology.py",
    ...
    "data": (
        ...
        "collection/sources/sead/test_sead_acquisition.py",
        "collection/sources/sead/test_sead_acquisition_admission.py",
        "collection/sources/sead/test_sead_claim_bundle.py",
        "collection/sources/sead/test_sead_observation_acquisition.py",
        "collection/sources/sead/test_sead_scoped_acquisition.py",
        ...
        "collection/workflow/test_data_layout.py",
    ...
    "doc-counts": (
        ...
        "collection/catalog/test_source_spatiotemporal_posture.py",
        "collection/workflow/test_repository_snapshot.py",
